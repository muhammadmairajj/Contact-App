...
class MainActivity : AppCompatActivity() {
            ...
            if (result.resultCode == Activity.RESULT_OK) {
                ...
                if (data != null) {
                    ...
                    if (contactUri != null) {
                        ...
                        phone.text = "Phone Number: $phoneNumber"
                    }
                }
            }
        }

        // select a contact with the help of button
    ...
    // Check if contact read permission is granted or not
    ...
    @SuppressLint("Range")
    // fetching the phone numbers from mobile phones
